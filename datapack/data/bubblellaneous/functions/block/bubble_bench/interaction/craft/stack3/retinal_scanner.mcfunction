...
execute if score $Material1 bubblellaneous matches 8.. if score $Material2 bubblellaneous matches 1.. if score $Material3 bubblellaneous matches 1.. run clear @p ender_eye 1
