...
execute store result score $Material2 bubblellaneous run clear @p red_dye 0
execute if score $Material1 bubblellaneous matches 1.. if score $Material2 bubblellaneous matches 1.. run clear @p brick 1
execute if score $Material1 bubblellaneous matches 1.. if score $Material2 bubblellaneous matches 1.. run clear @p red_dye 1
