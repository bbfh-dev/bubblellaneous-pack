...
execute store result score $Material2 bubblellaneous run clear @p tripwire_hook 0
execute if score $Material1 bubblellaneous matches 3.. if score $Material2 bubblellaneous matches 1.. run clear @p iron_ingot 3
execute if score $Material1 bubblellaneous matches 3.. if score $Material2 bubblellaneous matches 1.. run clear @p tripwire_hook 1
