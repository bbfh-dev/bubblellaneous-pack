...
data modify entity @e[type=armor_stand, tag=buln.stand, limit=1] ArmorItems[3].tag.CustomModelData set from entity @p Inventory[{tag:{Bubblellaneous:{pack:1b}}}].tag.CustomModelData
