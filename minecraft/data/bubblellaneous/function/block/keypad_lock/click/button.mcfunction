...
execute store result entity @s item.components."minecraft:custom_data".bubblellaneous.block_properties.pincode int 1 run scoreboard players operation pincode local.tmp += number local.tmp
