...
execute store success score success.1 local.tmp run data modify storage bubblellaneous tmp.compare.components set from entity @p[tag=--local.event_player] SelectedItem.components
