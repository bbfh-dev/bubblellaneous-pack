...
data modify entity @s item.components."minecraft:custom_data".bubblellaneous.block_properties.lock_item.components set from entity @p[tag=--local.event_player] SelectedItem.components
