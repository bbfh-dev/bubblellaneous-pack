...
# Ignore empty slots
execute if data storage bubblellaneous tmp.entry.components{"minecraft:custom_model_data": 370000} run return 0
execute if data storage bubblellaneous tmp.entry.components{"minecraft:custom_model_data": 370001} run return 0
