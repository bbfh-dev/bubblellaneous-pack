...
execute if data storage bubblellaneous tmp.entry.tag.bubblellaneous{action: "close_variant"} run function bubblellaneous:block/bubble_bench/entry/event/click/close_variant
