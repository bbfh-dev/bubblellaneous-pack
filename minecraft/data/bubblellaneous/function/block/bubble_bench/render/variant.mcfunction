execute store result score size local.tmp store result score max_pages local.tmp run data get entity @s item.components."minecraft:custom_data".bubblellaneous.block_properties.items
