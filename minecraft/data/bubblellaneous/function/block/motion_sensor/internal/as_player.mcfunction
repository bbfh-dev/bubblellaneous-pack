...
data modify storage bubblellaneous tmp.compare set from entity @e[type=item_display,tag=--local.this,limit=1] item.components."minecraft:custom_data".bubblellaneous.block_properties.owner
