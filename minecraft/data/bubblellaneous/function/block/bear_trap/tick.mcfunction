...
execute positioned ~-0.05 ~-0.05 ~-0.05 as @p[gamemode=!spectator,gamemode=!adventure,dx=0,dy=0,dz=0] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0,dy=0,dz=0] run function bubblellaneous:block/bear_trap/catch
