$execute if entity @s[nbt={item:{tag:{"minecraft:custom_data": {bubblellaneous:{block_data:{block_type: {name: "default"}}}}}}] run return run function bubblellaneous:block/$(name)/place
