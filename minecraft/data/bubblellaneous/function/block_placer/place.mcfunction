...
$summon item_display ~ ~ ~ {Tags: ["+bubblellaneous", "local.block", "local.name.$(name)", "--local.new"], CustomName: $(display_name), item: {id: "$(base_item)", count:1, components:{item_model:"bubblellaneous:$(id)", custom_model_data:$(custom_model_data)}, width: 1f, height: 1f}}
