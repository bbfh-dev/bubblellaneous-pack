...
data modify entity @e[type=item,nbt={Age: 0s},distance=..2,limit=1,sort=nearest] Item.components."minecraft:entity_data".Item.components."minecraft:custom_data".bubblellaneous.block_properties set from storage bubblellaneous tmp.in.block_properties
