...
# Ignore empty slots
execute as @s[nbt={Item: {components: {"minecraft:custom_model_data": 370000}}}] run return run kill @s
execute as @s[nbt={Item: {components: {"minecraft:custom_model_data": 370001}}}] run return run kill @s
