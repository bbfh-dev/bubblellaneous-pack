...
execute if score uses_blockstates local.tmp matches 1 run function bubblellaneous:block_placer/internal/update_blockstates with entity @s item.components."minecraft:custom_data".bubblellaneous.block_data
