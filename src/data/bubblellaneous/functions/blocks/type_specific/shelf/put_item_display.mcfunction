...
execute store result score count local.tmp run data get entity @p[tag=--local.player] SelectedItem.Count
execute if score count local.tmp matches 8.. run function bubblellaneous:blocks/type_specific/shelf/details/small_pile
