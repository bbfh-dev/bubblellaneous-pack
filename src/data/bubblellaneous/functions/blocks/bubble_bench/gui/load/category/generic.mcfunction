...
function bubblellaneous:blocks/bubble_bench/gui/load/gui/entry/get_by_category with storage bubblellaneous tmp.input
...
function bubblellaneous:blocks/bubble_bench/gui/load/gui/entry/render
