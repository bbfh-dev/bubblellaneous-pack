function bubblellaneous:blocks/bubble_bench/gui/load/ui/entry/next_container_index
...
function bubblellaneous:blocks/bubble_bench/gui/load/ui/entry/insert_item with storage bubblellaneous tmp.entry
