...
item modify block ~ ~ ~ container.0 bubblellaneous:block/bubble_bench/mark_as_furniture

loot replace block ~ ~ ~ container.1 loot bubblellaneous:block/iron_ladder
item modify block ~ ~ ~ container.1 bubblellaneous:block/mark_as_icon
item modify block ~ ~ ~ container.1 bubblellaneous:block/bubble_bench/mark_as_technology
...
execute if score @s local.block.predicate matches 0 run function bubblellaneous:blocks/bubble_bench/gui/load/gui/set_page_arrows {left: 370003, left_action: "none", right: 370005, right_action: "none"}
execute if score @s local.block.predicate matches 1 run function bubblellaneous:blocks/bubble_bench/gui/load/gui/set_page_arrows {left: 370002, left_action: "previous_page", right: 370005, right_action: "none"}
execute if score @s local.block.predicate matches 2 run function bubblellaneous:blocks/bubble_bench/gui/load/gui/set_page_arrows {left: 370003, left_action: "none", right: 370004, right_action: "next_page"}
execute if score @s local.block.predicate matches 3 run function bubblellaneous:blocks/bubble_bench/gui/load/gui/set_page_arrows {left: 370002, left_action: "previous_page", right: 370004, right_action: "next_page"}
#endregion
