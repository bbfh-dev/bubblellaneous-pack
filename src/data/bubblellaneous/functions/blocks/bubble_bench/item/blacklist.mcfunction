...
execute if data storage bubblellaneous tmp.entry.tag.EntityTag.Item.tag.item_data run data modify storage bubblellaneous tmp.input.name set from storage bubblellaneous tmp.entry.tag.EntityTag.Item.tag.item_data.name
