...
execute as @e[type=item_display,tag=--local.name.pipe,tag=!--local.cached,distance=..5,limit=1,sort=nearest] at @s run function bubblellaneous:blocks/radiator/radiate_to_pipes
