summon interaction ~ ~.55 ~ {Tags: ["+bubblellaneous", "local.seat", "--local.new"], width: 0.5f, height: 0.1f, response: 1b}

execute as @e[type=interaction,tag=--local.new,limit=1] run tp @s ~ ~.55 ~ ~ ~
