...
execute positioned ~ ~-1 ~ as @e[type=item_display,tag=--local.name.rising_door,distance=..0.5,scores={local.block.state=1}] at @s run function bubblellaneous:blocks/rising_door/close
execute positioned ~ ~1 ~ as @e[type=item_display,tag=--local.name.rising_door,distance=..0.5,scores={local.block.state=1}] at @s run function bubblellaneous:blocks/rising_door/close
execute positioned ~-1 ~ ~ as @e[type=item_display,tag=--local.name.rising_door,distance=..0.5,scores={local.block.state=1}] at @s run function bubblellaneous:blocks/rising_door/close
execute positioned ~1 ~ ~ as @e[type=item_display,tag=--local.name.rising_door,distance=..0.5,scores={local.block.state=1}] at @s run function bubblellaneous:blocks/rising_door/close
execute positioned ~ ~ ~-1 as @e[type=item_display,tag=--local.name.rising_door,distance=..0.5,scores={local.block.state=1}] at @s run function bubblellaneous:blocks/rising_door/close
...
data modify entity @s transformation set value {translation: [0f, 0.5f, 0f], scale: [1.01f, 1.01f, 1.01f], left_rotation: [0f, 0f, 0f, 1f], right_rotation: [0f, 0f, 0f, 1f]}
