...
data modify storage bubblellaneous tmp.in set from entity @s item.tag.bubblellaneous.block_properties.camera.location
...
execute store result score @p[tag=--local.event_player] local.block.id run data get entity @s item.tag.bubblellaneous.block_properties.camera.id
