summon armor_stand ^ ^ ^0.25 {Tags: ["+bubblellaneous", "local.keystrokes", "--local.new"], Small: 1b, NoBasePlate: 1b, Silent: 1b, NoGravity: 1b, Invisible: 1b, Marker: 1b}
...
tp @e[type=armor_stand,tag=--local.new,limit=1] ^ ^ ^0.25 ~180 ~
