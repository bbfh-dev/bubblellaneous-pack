...
execute if score @s local.block_state matches 0 run function bubblellaneous:block/id/bubble_bench/render_category
execute if score @s local.block_state matches 1 run function bubblellaneous:block/id/bubble_bench/render_variant
...
execute if score @s local.gui.page > max_pages local.tmp run function bubblellaneous:block/id/bubble_bench/go_to_latest_page
