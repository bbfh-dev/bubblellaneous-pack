...
execute if score length.2 local.tmp matches 1.. run function bubblellaneous:block/id/bubble_bench/crafting/take_items with storage bubblellaneous tmp.out.recipe[-1]
