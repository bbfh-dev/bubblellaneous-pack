...
function bubblellaneous:block/id/bubble_bench/entry/fetch/by_category with storage bubblellaneous tmp.input
...
function bubblellaneous:block/id/bubble_bench/entry/render

scoreboard players add i local.tmp 1
$function bubblellaneous:block/id/bubble_bench/render/generic_category {category: "$(category)"}
