...
function bubblellaneous:block/id/bubble_bench/entry/fetch/by_variant with storage bubblellaneous tmp.input
...
function bubblellaneous:block/id/bubble_bench/render/variant/loop
