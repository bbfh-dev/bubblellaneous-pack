...
execute store result score owner_uuid.0 local.tmp run data get entity @s item.tag.bubblellaneous.block_properties.owner_uuid[0]
execute store result score owner_uuid.1 local.tmp run data get entity @s item.tag.bubblellaneous.block_properties.owner_uuid[1]
execute store result score owner_uuid.2 local.tmp run data get entity @s item.tag.bubblellaneous.block_properties.owner_uuid[2]
execute store result score owner_uuid.3 local.tmp run data get entity @s item.tag.bubblellaneous.block_properties.owner_uuid[3]
