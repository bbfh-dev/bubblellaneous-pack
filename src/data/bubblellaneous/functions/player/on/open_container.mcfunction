...
execute anchored eyes positioned ^ ^ ^2 as @e[type=item_display,tag=--local.name.radiator,limit=1,sort=nearest] at @s if block ~ ~ ~ barrel[open=true] run function bubblellaneous:blocks/radiator/toggle
