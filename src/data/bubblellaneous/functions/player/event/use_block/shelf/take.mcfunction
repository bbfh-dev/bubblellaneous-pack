...
execute as @e[type=interaction,tag=--local.target_entity,scores={local.block_state=1}] at @s run function bubblellaneous:blocks/type_specific/shelf/action/take
