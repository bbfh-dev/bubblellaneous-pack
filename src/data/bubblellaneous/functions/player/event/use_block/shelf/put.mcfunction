...
execute as @e[type=interaction,tag=--local.target_entity,scores={local.block_state=0}] at @s run function bubblellaneous:block/type_specific/shelf/action/put
