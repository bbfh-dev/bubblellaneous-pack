...
execute if data storage bubblellaneous tmp.in{facing: "normal"} store result storage bubblellaneous tmp.in.rotation_x int 1 run function bubblellaneous:placer/internal/facing/normal
execute if data storage bubblellaneous tmp.in{facing: "wall_normal"} store result storage bubblellaneous tmp.in.rotation_x int 1 run function bubblellaneous:placer/internal/facing/wall_normal
execute if data storage bubblellaneous tmp.in{facing: "door"} store result storage bubblellaneous tmp.in.rotation_x int 1 run function bubblellaneous:placer/internal/facing/door
