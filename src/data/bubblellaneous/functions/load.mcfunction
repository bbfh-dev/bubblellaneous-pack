...
scoreboard objectives add local.on_sneak custom:sneak_time
...
function bubblellaneous:utils/set_default {name: "cameras.disable", value: 0, objective: "local.settings"}
function bubblellaneous:utils/set_default {name: "cameras.is_fixed", value: 0, objective: "local.settings"}
