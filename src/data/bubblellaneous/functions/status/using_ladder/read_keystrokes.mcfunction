...
execute unless score vector.rotation local.tmp matches 100.. run function bubblellaneous:status/using_ladder/keystrokes/holding_w
execute if score vector.rotation local.tmp matches 100.. run function bubblellaneous:status/using_ladder/keystrokes/holding_s
