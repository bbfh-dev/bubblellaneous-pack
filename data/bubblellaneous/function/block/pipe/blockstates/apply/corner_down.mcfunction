...
scoreboard players set @s bbln.block.model 6
data modify entity @s item.components.minecraft:custom_data.bubblellaneous.block_properties.block_state set value "corner_down"
...
data modify storage bubblellaneous tmp.in.index set value 6
