...
scoreboard players set @s bbln.block.model 16
data modify entity @s item.components.minecraft:custom_data.bubblellaneous.block_properties.block_state set value "partial_horizontal"
...
data modify storage bubblellaneous tmp.in.index set value 16
