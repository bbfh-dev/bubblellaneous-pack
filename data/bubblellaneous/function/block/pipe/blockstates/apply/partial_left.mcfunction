...
scoreboard players set @s bbln.block.model 18
data modify entity @s item.components.minecraft:custom_data.bubblellaneous.block_properties.block_state set value "partial_left"
...
data modify storage bubblellaneous tmp.in.index set value 18
