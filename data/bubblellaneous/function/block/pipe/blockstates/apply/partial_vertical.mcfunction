...
scoreboard players set @s bbln.block.model 17
data modify entity @s item.components.minecraft:custom_data.bubblellaneous.block_properties.block_state set value "partial_vertical"
...
data modify storage bubblellaneous tmp.in.index set value 17
