...
data modify storage bubblellaneous tmp.input.name set from storage bubblellaneous tmp.entry.components."minecraft:entity_data".Item.components."minecraft:custom_data".bubblellaneous.block_data.id
