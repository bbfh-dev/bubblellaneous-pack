...
execute if score #modifier.shift bbln.tmp matches 0 run function bubblellaneous:block/bubble_bench/entry/event/click_gui_normal
execute if score #modifier.shift bbln.tmp matches 1 run function bubblellaneous:block/bubble_bench/entry/event/click_gui_shift
