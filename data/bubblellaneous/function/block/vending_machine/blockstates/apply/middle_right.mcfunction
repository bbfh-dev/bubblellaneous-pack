...
scoreboard players set @s bbln.block.model 11
data modify entity @s item.components.minecraft:custom_data.bubblellaneous.block_properties.block_state set value "middle_right"
...
data modify storage bubblellaneous tmp.in.index set value 11
