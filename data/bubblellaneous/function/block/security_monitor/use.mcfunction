...
execute if score @s bbln.block.model matches 1 run return run function bubblellaneous:block/security_monitor/internal/error_offline
execute if score @s bbln.block.model matches 2 run return run function bubblellaneous:block/security_monitor/internal/error_disabled
