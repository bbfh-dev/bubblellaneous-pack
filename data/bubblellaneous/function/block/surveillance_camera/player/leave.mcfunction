...
tag @s remove --bbln.camera.spectating
tag @s add --bbln.camera.leaving

function bubblellaneous:utils/get_player_entry with entity @s
function bubblellaneous:block/surveillance_camera/player/multidimension_teleport with storage bubblellaneous tmp.entry
...
$execute unless score #1 bbln.int matches $(change_gamemode) run return 0
